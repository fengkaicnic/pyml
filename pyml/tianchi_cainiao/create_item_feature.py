...
try:
    ...
    cur = conn.cursor()
    companysql = 'create table item_feature(id int primary key not null auto_increment, date varchar(12), \
                   item_id int, cate_id int, cate_level_id int, brand_id int, supplier_id int, \
