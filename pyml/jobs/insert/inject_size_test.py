    ...
    with open('d:/jobs/test.json') as file:
        ...
        for line in linelst:
            if line:
                ...
                i = 1
                for workdct in workexperiencelst[:3]:
                    if workdct is None:
                        continue
                    print workdct
                    worksql = 'insert into work_sizetest (userid, department, end_date, industry, position_name, salary, size, start_date, type, num) values \
