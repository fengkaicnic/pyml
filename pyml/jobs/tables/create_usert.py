...
try:
    ...
    cur = conn.cursor()
    sql1 = 'drop '
    scoresql = 'create table jobs_uinfotest(id int primary key not null auto_increment, userid varchar(64), age int, degree int, gender varchar(12), major varchar(128)\
