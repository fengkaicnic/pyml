...
try:
    ...
    cur = conn.cursor()
    scoresql = 'create table work_sizetest(id int primary key not null auto_increment, userid varchar(64), \
    department varchar(255), end_date varchar(12), industry varchar(255), position_name varchar(255),\
    salary int, size int, start_date varchar(12), type varchar(128), num int, position_alias varchar(96))'
