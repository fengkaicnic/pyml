...
#         print j
        ...
        t += 1
        print t
        for letter in works[0][1]:
            if workprobdct[works[1][1]]['pos1'].has_key(letter):
                workprobdct[works[1][1]]['pos1'][letter] += 1
            else:
                workprobdct[works[1][1]]['pos1'][letter] = 1
        for letter in works[2][1]:
            if workprobdct[works[1][1]]['pos2'].has_key(letter):
                workprobdct[works[1][1]]['pos2'][letter] += 1
            else:
                workprobdct[works[1][1]]['pos2'][letter] = 1
        for letter in works[0][0]:
            if workprobdct[works[1][1]]['industry1'].has_key(letter):
                workprobdct[works[1][1]]['industry1'][letter] += 1
            else:
                workprobdct[works[1][1]]['industry1'][letter] = 1
        for letter in works[2][0]:
            if workprobdct[works[1][1]]['industry2'].has_key(letter):
                workprobdct[works[1][1]]['industry2'][letter] += 1
            else:
                workprobdct[works[1][1]]['industry2'][letter] = 1
