...
try:
    ...
    cur.execute(sql)
    file = open('d:/jobs/dctree/random/train.csv', 'w+')
    useridlst = cur.fetchall()
    sqlze = 'select userid, size, salary, industry from work_size limit 180000'
    cur.execute(sqlze)
    ...
    #file.write('age,start_age,bstart_year,start_salary,gender,major,size1,size2,salary1,salary2,industry1,industry2,size\n')
